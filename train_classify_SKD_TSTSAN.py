...
from train.train_classify_SKD_TSTSAN_functions_1 import main_SKD_TSTSAN_with_Aug_with_SKD
...
if __name__ == '__main__':
    ...
    parser.add_argument('--main_path', type=str, default="/kaggle/working/CASME2_retinaface_loso", help="path to the dataset directory")
    parser.add_argument('--exp_name', type=str, default="exp_CASME2", help="name of the folder to save experimental results,只是文件名不是路径")

...
if __name__ == "__main__":
    ...
    output_folder = "/kaggle/working/casme2-onset-apex-offset-retinaface/CASME2_optflow_retinaface"
    main(input_folder, output_folder)
    zipPath = '/kaggle/working/casme2-onset-apex-offset-retinaface/CASME2_optflow_retinaface.zip'

...
if __name__ == "__main__":
    ...
    zipPath = '/root/autodl-tmp/working/CASME2_onset_apex_offset.zip'
    ...
    zipPath = '/root/autodl-tmp/working/SAMM_onset_apex_offset.zip'
    ...
    zipPath = '/root/autodl-tmp/working/CASME3_onset_apex_offset.zip'
